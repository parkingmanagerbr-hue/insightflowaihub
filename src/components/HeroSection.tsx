      ...
      <div className="container mx-auto px-4 py-20 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <span className="text-sm font-medium text-white/90">{t("landing.hero.badge")}</span>
          </motion.div>
          ...
          >
            ...
            <span className="gradient-text">Ollama</span>{" "}
            {"e"}{" "}
          ...
          >
            ...
            >
              <a href="#funcionalidades">{t("landing.hero.viewFeatures")}</a>
            </Button>
          </motion.div>
          ...
          >
            <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10">
              ...
              <span className="text-sm text-white/80">{t("landing.hero.multiDatabase")}</span>
            </div>
            <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10">
              <Sparkles className="w-4 h-4 text-[hsl(210,100%,56%)]" />
              <span className="text-sm text-white/80">{t("landing.hero.sqlOllama")}</span>
            </div>
            <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10">
              <BarChart3 className="w-4 h-4 text-[hsl(210,100%,56%)]" />
              <span className="text-sm text-white/80">{t("landing.hero.powerBIEmbedded")}</span>
            </div>
          </motion.div>
        </div>
